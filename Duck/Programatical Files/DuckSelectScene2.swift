...
class DuckSelectScene2: SKScene {
    ...
    func createButtons() {
        ...
        let selectButton = Duck2Button(defaultTexture: normalTexture2, selectedTexture: selectedTexture2, size: CGSize(width: 250, height: 250))
