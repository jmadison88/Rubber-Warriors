...
class DuckSelectScene3: SKScene {
    ...
    func createButtons() {
        ...
        let selectButton = Duck3Button(defaultTexture: normalTexture2, selectedTexture: selectedTexture2, size: CGSize(width: 250, height: 250))
