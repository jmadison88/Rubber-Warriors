...
class Level1Scene: SKScene {
    ...
    func ifgooseSurprised() {
        let changeToNewTexture = SKAction.setTexture(SKTexture(imageNamed: "SurprisedGoose"))
        let waitDuration = 0.5 // Change this to the desired wait time in seconds
        let waitAction = SKAction.wait(forDuration: waitDuration)
        let changeBackToOriginalTexture = SKAction.setTexture(SKTexture(imageNamed: "goose"))
    ...
    func ifgooseSurprised2() {
        let changeToNewTexture2 = SKAction.setTexture(SKTexture(imageNamed: "SurprisedGoose"))
        ...
        let changeBackToOriginalTexture2 = SKAction.setTexture(SKTexture(imageNamed: "goose"))
        let gooseSurprised = SKAction.moveTo(y: frame.midY + 150, duration: 0.1)
        let gooseSurprised2 = SKAction.moveTo(y: frame.midY + 100, duration: 0.1)
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if enemyHp <= 0 && !backButtonCreated {
            ...
            LevelSelectScene.level1Complete = true
